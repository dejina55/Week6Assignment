package com.dejina.week6assignment.Adapter
...
class StudentAdapter(val context: Context, val lstStudent: ArrayList<Student>) :
    RecyclerView.Adapter<StudentAdapter.StudentViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentViewHolder {
        val view =
            LayoutInflater.from(this.context).inflate(R.layout.student_layout, parent, false);
